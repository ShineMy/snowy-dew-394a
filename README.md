...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/snowy-dew-394a)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/snowy-dew-394a
```

A live public deployment of this template is available at [https://snowy-dew-394a.templates.workers.dev](https://snowy-dew-394a.templates.workers.dev)
